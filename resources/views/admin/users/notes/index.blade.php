                            ...
                            @foreach($data['notes'] as $note)
                                <tr class="odd">
                                    ...
                                    <td><a style="word-break:break-all;" href=""
                                           target="_blank">
                                            <p>#{{ $data['user']->id }}<br>{{ $data['user']->username }}</p>
                                            <p style="font-size:10px;color:#8e5fa2;">{{ $data['user']->email }}</p>
                                        </a></td>
                                    <td><a style="word-break:break-all;" href=""
                                           target="_blank">
                                    ...
                                    <td>
                                        <div class="btn-group" style="width:122px;">
                                            <a
                                                ...
                                                href="{{ route('admin.users.notes.edit',[$data['user']->id,$note->id]) }}" data-original-title="Update"> </a>
                                            <button
                                            ...
                                            <form action="{{ route('admin.users.notes.destroy',[$data['user']->id,$note->id]) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                            </form>
                                        </div>
