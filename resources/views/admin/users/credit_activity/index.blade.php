            ...
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    <div id="yw0" class="grid-view">
                        <div class="summary">Displaying 1-50 of {{ $credits->count() }} results.</div>
                        <table class="table table-striped table-bordered table-condensed">
                            ...
                            <tr>
                                ...
                                <th id="yw0_c5">Credit Before</th>
                                <th id="yw0_c6"><a class="sort-link" href="/adminUser/index?User_sort=timestamp">Credit After</a>
                            ...
                            @foreach($credits as $credit)
                                <tr class="odd">
                                    ...
                                    <td><a style="word-break:break-all;" href="" target="_blank">
                                            <p>#{{ $credit->user->id }}<br>{{ $credit->user->email }}</p>
                                            <p style="font-size:10px;color:#8e5fa2;">{{ $credit->user->email }}</p>
                                        </a></td>
                                    <td>{{ $credit->type }}</td>
                                    <td>{{ $credit->description }}</td>
                                    <td class="{{ $credit->change > 0 ? 'text-success':'text-danger' }}">{{ $credit->change }}</td>
                                    <td>{{ $credit->credits_before }}</td>
                                    <td>{{ $credit->credits_after }}</td>
