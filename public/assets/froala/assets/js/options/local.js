var FroalaOptions = {
    ...
    inlineStyles: {
        ...
        'Notice': 'font-family: Lato, sans-serif; font-size: 14px;font-weight: bold; text-transform: uppercase;color: #FBA026;'
    },
    imageUploadURL: '/op/froalaEditor/upload/image',
    imageManagerLoadURL: '/op/froalaEditor/upload/manager',
    imageManagerDeleteURL: '/op/froalaEditor/upload/delete',
    fileUploadURL: '/op/froalaEditor/upload/file',
    ...
    codeMirror: false,
    toolbarSticky: false,
    toolbarButtons: ['bold', 'italic', 'underline', 'strikeThrough', 'subscript', 'superscript', 'fontFamily', 'inlineStyle', 'fontSize', '|', 'color', 'emoticons', 'paragraphStyle', '-', 'paragraphFormat', 'align', 'formatOL', 'formatUL', 'outdent', 'indent', 'quote', 'insertHR', '|', 'insertLink', 'insertImage', 'insertVideo', 'insertFile', 'insertTable', 'undo', 'redo', 'clearFormatting', 'html'],
    emoticonsStep: 15,
    emoticonsSet: [
