var FroalaOptions = {
    ...
    inlineStyles: {
        ...
        'Notice': 'font-family: Lato, sans-serif; font-size: 18px;font-weight: bold; text-transform: uppercase;color: #FBA026;'
    },
    imageUploadURL: '/froalaEditor/upload/image',
    imageManagerLoadURL: '/froalaEditor/upload/manager',
    imageManagerDeleteURL: '/froalaEditor/upload/delete',
    fileUploadURL: '/froalaEditor/upload/file',
