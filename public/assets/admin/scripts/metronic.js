...
var Metronic = function() {
    ...
    //enable spinner
     $('#spinnerProductCategories').spinner({step: 1, min: -1, max: 99});
     $('#spinner10').spinner({step: 10, min: -100000, max: 100000});
     $('#spinner1').spinner({step: 1, min: 0, max: 100000,value:0});
    ...
    return {
        ...
        startPageLoading: function(options) {
            if (options && options.animate) {
                ...
                $('.page-loading').remove();
                $('body').append('<div class="page-loading"><img src="/images/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (options && options.message ? options.message : 'Loading...') + '</span></div>');
            }
        },
